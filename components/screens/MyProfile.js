        ...
        return (
            <Wrapper withContainer header={{
                ...
                <List.Section>
                    ...
                    <AccordionItem title={'Персональные данные'} expanded>
                    ...
                    <AccordionItem title={'QR-визитка'}>
                        <View style={styles.imageBlock}>
                            <View style={styles.imageView}>
                                <Image
                    ...
                    <AccordionItem title={'Настройка уведомлений'}>
                    ...
                    <AccordionItem title={'Действия с профилем'}>
                        <BlockWithSwitchButton
